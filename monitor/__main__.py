...
async def aggregator(exporter: ChiaExporter, notifier: Optional[Notifier], rpc_hostname: str, rpc_refresh_interval: int,
    ...
    try:
        ...
        rpc_collector = await RpcCollector.create(DEFAULT_ROOT_PATH, chia_config, event_queue, rpc_hostname, rpc_refresh_interval)
...
if __name__ == "__main__":
    ...
    try:
        ...
        rpc_hostname = config["rpc_collector"]["hostname"]
    ...
    try:
        asyncio.run(aggregator(exporter, notifier, rpc_hostname, rpc_refresh_interval, price_refresh_interval))
